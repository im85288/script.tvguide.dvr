...
for path in unique:
    ...
    for file in thumbnails:
        ...
        thumbs[file] = thumb
logo_folder = 'special://profile/addon_data/script.tvguide.dvr/logos/'
for addonId in sorted(logos):
    folder = 'special://profile/addon_data/script.tvguide.dvr/logos/%s' % addonId
...
dialog.notification("TV Guide DVR","Done: Download Logos")
